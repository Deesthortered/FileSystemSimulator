...
public class mkfs
{
    ...
    */
        ...
        rootIndexNode.write( rootInodeBlock.bytes , ( FileSystem.ROOT_INDEX_NODE_NUMBER * IndexNode.INDEX_NODE_SIZE ) % block_size ) ;

        // ??? write the rest of the inodes in the first block

        // write the first inode block
        file.seek( inodeBlockOffset * block_size + FileSystem.ROOT_INDEX_NODE_NUMBER * IndexNode.INDEX_NODE_SIZE ) ;
        ...
        DirectoryEntry itself = new DirectoryEntry( FileSystem.ROOT_INDEX_NODE_NUMBER , "." ) ;
        DirectoryEntry parent = new DirectoryEntry( FileSystem.ROOT_INDEX_NODE_NUMBER , ".." ) ;
